...
async function seed() {
  ...
  await createProperty({
    ...
    address: 'Linking Road, Bandra West, Mumbai', pincode: '400050', latitude: 19.0596, longitude: 72.8295, status: PropertyStatus.ACTIVE,
  ...
  await createProperty({
    ...
    address: 'Hiranandani Gardens, Powai, Mumbai', pincode: '400076', latitude: 19.1197, longitude: 72.9054,
    isFeatured: false, isPremium: true, isVerified: true, listingPlan: ListingPlan.PREMIUM, status: PropertyStatus.ACTIVE,
  ...
  await createProperty({
    ...
    address: 'Juhu Tara Road, Juhu, Mumbai', pincode: '400049', latitude: 19.1075, longitude: 72.8263, status: PropertyStatus.ACTIVE,
    isFeatured: true, isPremium: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
  ...
  await createProperty({
    ...
    address: 'J.B. Nagar, Andheri East, Mumbai', pincode: '400069', latitude: 19.1136, longitude: 72.8697, status: PropertyStatus.ACTIVE,
  ...
  await createProperty({
    ...
    address: 'Pali Hill, Bandra West, Mumbai', pincode: '400050', latitude: 19.0543, longitude: 72.8258, status: PropertyStatus.ACTIVE,
  ...
  await createProperty({
    ...
    address: 'Vasant Kunj Enclave, New Delhi', pincode: '110070', latitude: 28.5204, longitude: 77.1583, status: PropertyStatus.ACTIVE,
    isFeatured: true, isPremium: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
  ...
  await createProperty({
    ...
    furnishingStatus: FurnishingStatus.FURNISHED, possessionStatus: PossessionStatus.READY_TO_MOVE,
    city: 'Delhi', state: 'Delhi', locality: 'Saket', address: 'Saket, New Delhi', pincode: '110017', latitude: 28.5244, longitude: 77.2167, status: PropertyStatus.ACTIVE,
  ...
  await createProperty({
    ...
    address: '5th Block, Koramangala, Bangalore', pincode: '560034', latitude: 12.9352, longitude: 77.6245, status: PropertyStatus.ACTIVE,
    isFeatured: true, isPremium: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
  ...
  await createProperty({
    ...
    address: 'EPIP Zone, Whitefield, Bangalore', pincode: '560066', latitude: 12.9698, longitude: 77.7500, status: PropertyStatus.ACTIVE,
  ...
  await createProperty({
    ...
    address: '100 Feet Road, Indiranagar, Bangalore', pincode: '560038', latitude: 12.9719, longitude: 77.6412, status: PropertyStatus.ACTIVE,
    isFeatured: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Sector 2, HSR Layout, Bangalore', pincode: '560102', latitude: 12.9116, longitude: 77.6389, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Sector 137, Noida, UP', pincode: '201304', latitude: 28.5025, longitude: 77.3940, status: PropertyStatus.ACTIVE,
    isFeatured: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Sector 62, Noida', pincode: '201309', latitude: 28.6269, longitude: 77.3716, status: PropertyStatus.ACTIVE,
    isVerified: false, listingPlan: ListingPlan.FREE, approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Sector 12, Greater Noida West', pincode: '201306', latitude: 28.5867, longitude: 77.4234, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.AGENT,
  ...
  await createProperty({
    ...
    address: 'DLF Phase 2, Gurugram, Haryana', pincode: '122002', latitude: 28.4932, longitude: 77.0893, status: PropertyStatus.ACTIVE,
    isFeatured: true, isPremium: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Sohna Road, Gurugram', pincode: '122018', latitude: 28.4089, longitude: 77.0415, status: PropertyStatus.ACTIVE,
    isPremium: true, isVerified: true, listingPlan: ListingPlan.PREMIUM,
    listingExpiresAt: futureDate(60), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Gachibowli, Hyderabad', pincode: '500032', latitude: 17.4417, longitude: 78.3482, status: PropertyStatus.ACTIVE,
    isFeatured: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Kondapur, Hyderabad', pincode: '500084', latitude: 17.4604, longitude: 78.3574, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Road No. 36, Jubilee Hills, Hyderabad', pincode: '500033', latitude: 17.4293, longitude: 78.4070, status: PropertyStatus.ACTIVE,
    isFeatured: true, isPremium: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Baner Road, Pune', pincode: '411045', latitude: 18.5590, longitude: 73.7868, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.PREMIUM, listingExpiresAt: futureDate(60),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.AGENT,
  ...
  await createProperty({
    ...
    address: 'Viman Nagar, Pune', pincode: '411014', latitude: 18.5679, longitude: 73.9143, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Kothrud, Pune', pincode: '411038', latitude: 18.5074, longitude: 73.8175, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.PREMIUM, listingExpiresAt: futureDate(60),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Anna Nagar West, Chennai', pincode: '600040', latitude: 13.0850, longitude: 80.2101, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.PREMIUM, listingExpiresAt: futureDate(60),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.AGENT,
  ...
  await createProperty({
    ...
    address: 'Sholinganallur, OMR, Chennai', pincode: '600097', latitude: 12.8996, longitude: 80.2209, status: PropertyStatus.ACTIVE,
    isVerified: false, listingPlan: ListingPlan.FREE, approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Adyar, Chennai', pincode: '600020', latitude: 13.0012, longitude: 80.2565, status: PropertyStatus.ACTIVE,
    isFeatured: true, isPremium: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Sector III, Salt Lake, Kolkata', pincode: '700064', latitude: 22.5745, longitude: 88.4145, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'New Town, Rajarhat, Kolkata', pincode: '700135', latitude: 22.6128, longitude: 88.4694, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Technopolis Knowledge Park, Andheri East, Mumbai', pincode: '400093', latitude: 19.1136, longitude: 72.8697, status: PropertyStatus.ACTIVE,
  ...
  await createProperty({
    ...
    address: 'Inner Circle, Connaught Place, New Delhi', pincode: '110001', latitude: 28.6315, longitude: 77.2167, status: PropertyStatus.ACTIVE,
    isVerified: true, isFeatured: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: '1st Block, Koramangala, Bangalore', pincode: '560034', latitude: 12.9352, longitude: 77.6245, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.AGENT,
  ...
  await createProperty({
    ...
    address: 'Road No. 12, Banjara Hills, Hyderabad', pincode: '500034', latitude: 17.4167, longitude: 78.4320, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.PREMIUM, listingExpiresAt: futureDate(60),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.AGENT,
  ...
  await createProperty({
    ...
    address: 'NH-58, Industrial Area Phase 2, Ghaziabad', pincode: '201001', latitude: 28.6691, longitude: 77.4369, status: PropertyStatus.ACTIVE,
    isVerified: true, isFeatured: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Sector 63, Noida, UP', pincode: '201301', latitude: 28.6209, longitude: 77.3793, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.PREMIUM, listingExpiresAt: futureDate(60),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.AGENT,
  ...
  await createProperty({
    ...
    address: 'Bhiwandi Warehousing Hub, Thane', pincode: '421302', latitude: 19.2968, longitude: 73.0599, status: PropertyStatus.ACTIVE,
    isVerified: true, isFeatured: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'IDA Patancheru, Hyderabad', pincode: '502319', latitude: 17.5303, longitude: 78.2620, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.AGENT,
  ...
  await createProperty({
    ...
    address: '5th Block, Koramangala, Bangalore', pincode: '560095', latitude: 12.9352, longitude: 77.6245, status: PropertyStatus.ACTIVE,
    isVerified: true, isFeatured: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Near Cyber Hub, Sector 29, Gurgaon', pincode: '122002', latitude: 28.4730, longitude: 77.0942, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.PREMIUM, listingExpiresAt: futureDate(60),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Hiranandani Gardens, Powai, Mumbai', pincode: '400076', latitude: 19.1197, longitude: 72.9054, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Near Financial District, Gachibowli, Hyderabad', pincode: '500032', latitude: 17.4417, longitude: 78.3482, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Electronic City Phase 1, Bangalore', pincode: '560100', latitude: 12.8490, longitude: 77.6640, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.FREE, approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Thane West, Maharashtra', pincode: '400615', latitude: 19.2425, longitude: 72.9850, status: PropertyStatus.ACTIVE,
    isVerified: true, isFeatured: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Sarjapur Road, Bangalore', pincode: '560035', latitude: 12.9082, longitude: 77.6780, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.PREMIUM, listingExpiresAt: futureDate(60),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.AGENT,
  ...
  await createProperty({
    ...
    address: 'Whitefield, Bangalore', pincode: '560066', latitude: 12.9698, longitude: 77.7500, status: PropertyStatus.ACTIVE,
    isVerified: true, isFeatured: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Sector 150, Noida Expressway', pincode: '201310', latitude: 28.4624, longitude: 77.4876, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.PREMIUM, listingExpiresAt: futureDate(60),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.AGENT,
  ...
  await createProperty({
    ...
    address: 'Alibaug, Raigad, Maharashtra', pincode: '402201', latitude: 18.6438, longitude: 72.8721, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Near SG Highway, Ahmedabad', pincode: '380054', latitude: 23.0515, longitude: 72.5068, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Prahlad Nagar, Ahmedabad', pincode: '380015', latitude: 23.0225, longitude: 72.5170, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Vaishali Nagar, Jaipur', pincode: '302021', latitude: 26.9124, longitude: 75.7373, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.PREMIUM, listingExpiresAt: futureDate(60),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.AGENT,
  ...
  await createProperty({
    ...
    address: 'Gomti Nagar Extension, Lucknow', pincode: '226010', latitude: 26.8631, longitude: 81.0043, status: PropertyStatus.ACTIVE,
    isVerified: false, listingPlan: ListingPlan.FREE, approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Infopark Road, Kakkanad, Kochi', pincode: '682030', latitude: 10.0261, longitude: 76.3084, status: PropertyStatus.ACTIVE,
    isVerified: true, listingPlan: ListingPlan.BASIC, listingExpiresAt: futureDate(30),
    approvalStatus: ApprovalStatus.APPROVED, listedBy: ListingUserType.OWNER,
  ...
  await createProperty({
    ...
    address: 'Chattarpur Farms, South Delhi', pincode: '110074', latitude: 28.4956, longitude: 77.1785, status: PropertyStatus.ACTIVE,
    isFeatured: true, isPremium: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Plot No B-706, Tower C, KLJ Noida One, Sector 63 Rd, Noida', pincode: '201301', latitude: 28.6209, longitude: 77.3793, status: PropertyStatus.ACTIVE,
    isVerified: true, isFeatured: true, listingPlan: ListingPlan.FEATURED,
    listingExpiresAt: futureDate(90), approvalStatus: ApprovalStatus.APPROVED,
  ...
  await createProperty({
    ...
    address: 'Plot No B-706, KLJ Noida One, Sector 63 Rd, Noida', pincode: '201301', latitude: 28.6209, longitude: 77.3793, status: PropertyStatus.ACTIVE,
  ...
  const bulkCities = [
    { city: 'Mumbai', state: 'Maharashtra', locality: 'Andheri West', pin: '400058', lat: 19.1339, lng: 72.8264 },
    { city: 'Delhi', state: 'Delhi', locality: 'Rohini', pin: '110085', lat: 28.7041, lng: 77.1025 },
    { city: 'Bangalore', state: 'Karnataka', locality: 'Marathahalli', pin: '560037', lat: 12.9591, lng: 77.6974 },
    { city: 'Hyderabad', state: 'Telangana', locality: 'Manikonda', pin: '500089', lat: 17.4061, lng: 78.3813 },
    { city: 'Pune', state: 'Maharashtra', locality: 'Kharadi', pin: '411014', lat: 18.5531, lng: 73.9454 },
    { city: 'Noida', state: 'Uttar Pradesh', locality: 'Sector 50', pin: '201301', lat: 28.5993, lng: 77.3547 },
    { city: 'Gurgaon', state: 'Haryana', locality: 'Sector 56', pin: '122011', lat: 28.4184, lng: 77.1025 },
    { city: 'Chennai', state: 'Tamil Nadu', locality: 'Velachery', pin: '600042', lat: 12.9754, lng: 80.2207 },
    { city: 'Kolkata', state: 'West Bengal', locality: 'Rajarhat', pin: '700135', lat: 22.6128, lng: 88.4694 },
    { city: 'Ahmedabad', state: 'Gujarat', locality: 'Bopal', pin: '380058', lat: 23.0345, lng: 72.4710 },
    { city: 'Jaipur', state: 'Rajasthan', locality: 'Jagatpura', pin: '302017', lat: 26.8439, lng: 75.8514 },
    { city: 'Lucknow', state: 'Uttar Pradesh', locality: 'Hazratganj', pin: '226001', lat: 26.8513, lng: 80.9462 },
    { city: 'Mumbai', state: 'Maharashtra', locality: 'Goregaon East', pin: '400063', lat: 19.1613, lng: 72.8526 },
    { city: 'Delhi', state: 'Delhi', locality: 'Janakpuri', pin: '110058', lat: 28.6286, lng: 77.0786 },
    { city: 'Bangalore', state: 'Karnataka', locality: 'JP Nagar', pin: '560078', lat: 12.9077, lng: 77.5833 },
    { city: 'Hyderabad', state: 'Telangana', locality: 'Nallagandla', pin: '500019', lat: 17.4520, lng: 78.3157 },
    { city: 'Pune', state: 'Maharashtra', locality: 'Wakad', pin: '411057', lat: 18.5986, lng: 73.7681 },
    { city: 'Noida', state: 'Uttar Pradesh', locality: 'Sector 100', pin: '201301', lat: 28.5378, lng: 77.3590 },
    { city: 'Gurgaon', state: 'Haryana', locality: 'Palam Vihar', pin: '122017', lat: 28.5047, lng: 77.0215 },
    { city: 'Chennai', state: 'Tamil Nadu', locality: 'Porur', pin: '600116', lat: 13.0373, lng: 80.1576 },
    { city: 'Hyderabad', state: 'Telangana', locality: 'Kukatpally', pin: '500072', lat: 17.4848, lng: 78.3948 },
    { city: 'Bangalore', state: 'Karnataka', locality: 'Bellandur', pin: '560103', lat: 12.9253, lng: 77.6714 },
    { city: 'Mumbai', state: 'Maharashtra', locality: 'Chembur', pin: '400071', lat: 19.0522, lng: 72.8998 },
  ];
  ...
  await createProperty({
    ...
    address: 'Defence Colony, New Delhi', pincode: '110024', latitude: 28.5744, longitude: 77.2311,
    isFeatured: true, isPremium: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
  ...
  await createProperty({
    ...
    address: 'DLF Phase 5, Golf Course Road, Gurgaon', pincode: '122009', latitude: 28.4361, longitude: 77.1022,
    isFeatured: true, isPremium: true, isVerified: true, listingPlan: ListingPlan.FEATURED,
  ...
  await createProperty({
    ...
    address: 'Inner Circle, Connaught Place, New Delhi', pincode: '110001', latitude: 28.6315, longitude: 77.2167,
  ...
  const topCities = ['Mumbai', 'Delhi', 'Bangalore', 'Hyderabad', 'Chennai', 'Pune', 'Noida', 'Gurgaon', 'Kolkata', 'Ahmedabad'];

  // 10 groups, each with correct SEO-friendly URLs matching the App Router pages
  const footerGroups = [
    {
      title: 'Buy Property by City',
      sortOrder: 0,
      links: topCities.map((city, i) => ({
        label: `Property for Sale in ${city}`,
        url: `/property-for-sale-in-${slugOf(city)}`,
        sortOrder: i,
        isActive: true,
      })),
    },
    {
      ...
      sortOrder: 1,
      links: topCities.map((city, i) => ({
        label: `Property for Rent in ${city}`,
        url: `/property-for-rent-in-${slugOf(city)}`,
        sortOrder: i,
        isActive: true,
      })),
    },
    {
      ...
      sortOrder: 2,
      links: topCities.map((city, i) => ({
        label: `Flats for Sale in ${city}`,
        url: `/flats-for-sale-in-${slugOf(city)}`,
        sortOrder: i,
        isActive: true,
      })),
    },
    {
      ...
      sortOrder: 3,
      links: topCities.map((city, i) => ({
        label: `Flats for Rent in ${city}`,
        url: `/flats-for-rent-in-${slugOf(city)}`,
        sortOrder: i,
        isActive: true,
      })),
    },
    {
      ...
      sortOrder: 4,
      links: topCities.map((city, i) => ({
        label: `Villas for Sale in ${city}`,
        url: `/villas-for-sale-in-${slugOf(city)}`,
        sortOrder: i,
        isActive: true,
      })),
    },
    {
      ...
      sortOrder: 5,
      links: topCities.map((city, i) => ({
        label: `Plots for Sale in ${city}`,
        url: `/plots-for-sale-in-${slugOf(city)}`,
        sortOrder: i,
        isActive: true,
      })),
    },
    {
      ...
      sortOrder: 6,
      links: topCities.map((city, i) => ({
        label: `Commercial Property in ${city}`,
        url: `/commercial-property-in-${slugOf(city)}`,
        sortOrder: i,
        isActive: true,
      })),
    },
    {
      ...
      sortOrder: 7,
      links: topCities.map((city, i) => ({
        label: `Office Space for Rent in ${city}`,
        url: `/office-space-for-rent-in-${slugOf(city)}`,
        sortOrder: i,
        isActive: true,
      })),
    },
    {
      ...
      links: topCities.map((city, i) => ({
        ...
        url: `/new-projects-in-${slugOf(city)}`,
        sortOrder: i,
        isActive: true,
      })),
    },
  ...
  for (const groupDef of footerGroups) {
    const group = await footerGroupRepo.save({ title: groupDef.title, sortOrder: groupDef.sortOrder, isActive: true });
    for (const link of groupDef.links) {
      await footerLinkRepo.save({ groupId: group.id, ...link });
    }
  }
