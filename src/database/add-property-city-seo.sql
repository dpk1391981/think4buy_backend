-- Migration: Add property_city_seo table
-- Run once to add SEO management for /properties-in-[city] pages

CREATE TABLE IF NOT EXISTS `property_city_seo` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UQ_property_city_seo_city_slug` (`city_slug`),
  UNIQUE KEY `UQ_property_city_seo_slug` (`slug`)
