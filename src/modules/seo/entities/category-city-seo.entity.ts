...
/**
 * SEO config for Category + City combinations.
 * e.g. category=buy + city=gurgaon → "Buy Property in Gurgaon" page
 */
@Entity('category_city_seo')
@Index(['categorySlug', 'citySlug'], { unique: true })
export class CategoryCitySeo {
  @PrimaryGeneratedColumn('uuid')
  id: string;

  @Column({ name: 'category_slug', length: 100 })
  categorySlug: string; // 'buy', 'rent', 'pg', 'commercial', etc.
  ...
  /** URL slug: e.g. buy-property-in-gurgaon */
